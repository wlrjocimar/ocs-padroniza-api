...
@Component
public class PerguntaInputDTOValidator implements Validator {
	...
	public boolean supports(Class<?> clazz) {
		return PerguntaInputDTO.class.isAssignableFrom(clazz);
	}

	@Override
	public void validate(Object target, Errors errors) {
		 PerguntaInputDTO perguntaDTO = (PerguntaInputDTO) target;
